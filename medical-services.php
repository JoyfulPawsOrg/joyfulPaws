...
<head>
<title>Joyful Paws | Medical services</title>
  <meta charset="utf-8">
      ...
      <section id="banner" class="py-3" style="background: #F9F3EC;">
        <div class="container">
          <div class="hero-content py-5 my-3">
            <h2 class="display-1 mt-3 mb-0">Medical Services</h2>
          ...
          <div class="row entry-container">
            <div class="entry-item col-md-4 my-4">
              ...
              <div class="card position-relative">
                <a href="checkUp-service.php"><img src="images/checkUp1.jpg" class="img-fluid rounded-4" alt="image"></a>
                <div class="card-body p-0">
                  <a href="checkUp-service.php">
                    <h3 class="card-title pt-4 pb-3 m-0">Check ups</h3>
                  </a>
    
                  <div class="card-text">
                    <p class="blog-paragraph fs-6">Keep your furry friend in top shape with
                                                    our comprehensive pet check-up service – 
                                                    because their health and happiness matter as much as yours!</p>
                    <a href="checkUp-service.php" class="blog-read">book now ></a>
                    <!--<a href="checkUp-service.php?serviceType=CheckUp&servicePrice=100SAR" class="blog-read">book now </a>-->
            ...
            <div class="entry-item col-md-4 my-4">
              ...
              <div class="card position-relative">
                <a href="woundTreatment-service.php"><img src="images/injury1.jpg" class="img-fluid rounded-4" alt="image"></a>
                <div class="card-body p-0">
                  <a href="woundTreatment-service.php">
                    <h3 class="card-title pt-4 pb-3 m-0">Wounds treatment</h3>
                  </a>
    
                  <div class="card-text">
                    <p class="blog-paragraph fs-6">Trust our expert team to provide compassionate care
                                                  and effective treatment for your pet's injuries, helping them bounce back
                                                  to their playful selves in no time!</p>
                    <a href="woundTreatment-service.php" class="blog-read">book now ></a>
                    <!--<a href="woundTreatment-service.php?serviceType=WoundTreatment&servicePrice=150SAR" class="blog-read">book now </a>-->
                  </div>
            ...
            <div class="entry-item col-md-4 my-4">
              ...
              <div class="card position-relative">
                <a href="vaccination-service.php"><img src="images/vaccines1.jpg" class="img-fluid rounded-4" alt="image"></a>
                <div class="card-body p-0">
                  <a href="vaccination-service.php">
                    <h3 class="card-title pt-4 pb-3 m-0">Vaccinations</h3>
                  </a>
                  <div class="card-text">
                    <p class="blog-paragraph fs-6">Safeguard your pet's well-being with our reliable vaccination service,
                                                   ensuring they stay protected against common diseases and live their happiest,
                                                   healthiest lives by your side!"
                    </p>
                    <a href="vaccination-service.php" class="blog-read">book now ></a>
                    <!--<a href="vaccination-service.php?serviceType=vaccination&servicePrice=180SAR" class="blog-read">book now </a>-->
                  </div>
